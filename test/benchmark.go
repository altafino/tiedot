...
var benchSize = 1000000

func main() {
	fmt.Println("start bench 1 with 10 Mio recs")
	benchmark()
}
...
func benchmark() {
	...
	defer benchDB.Close()
	col.Index([]string{"contacts", "contact", "str"})
	col.Index([]string{"contacts", "contact", "int"})
	col.Index([]string{"contacts", "contact", "float"})
